...
{	
	...
	public bool FetchBone(KinectWrapper.NuiSkeletonPositionIndex boneIndex, out Transform boneToPick, ref Transform backUpBone)
	{
		if (bones != null && bones.Length > (int)boneIndex)
		{
			boneToPick = bones[(int) boneIndex];
			return true;
		}

		boneToPick = backUpBone;
